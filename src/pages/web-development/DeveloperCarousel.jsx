    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
          {/* Title */}
          <h2 className="mx-auto max-w-xl text-center text-3xl font-bold md:text-2xl mb-8 md:mb-12 lg:mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 mb-6">
            <div className="bg-gray-100 p-6 rounded-lg flex flex-col md:flex-row md:justify-between items-center">
              ...
              <div className="mt-5 md:mr-5 md:mt-5 pl-5">
                <img
                  src="https://www.revenueriver.co/hubfs/fullstack.jpeg"
            ...
            <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <div className="flex h-full w-full flex-col items-start justify-around px-0 py-4">
                  ...
                  Web Development bring your ideas to life with our expertise in web development, creating masterpieces that elevate your brand.
                  </p>
                </div>
              </a>
              {/* Blog Item */}
              ...
              >
                ...
                <div className="flex h-full w-full flex-col items-start justify-around px-0 py-4">
                  ...
                  <p className="text-sm max-w-72">
                  Mobile apps serve a wide range of purposes, from productivity tools to entertainment, communication, and social interaction.
                  </p>
                </div>
              </a>
              {/* Blog Item */}
              ...
              >
                ...
                <div className="flex h-full w-full flex-col items-start justify-around px-0 py-4">
                  ...
                  <p className="text-sm max-w-72">
                  The Art of  UI and UX are two essential elements in the design of digital products, especially mobile apps and websites.
                  </p>
                </div>
              </a>
            </div>
      ...
      <section>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-20">
          {/* Title */}
          <h2 className="mx-auto max-w-2xl text-center text-3xl font-bold md:text-4xl mb-8 md:mb-12 lg:mb-16">
            ...
            <div className="flex h-full flex-col [grid-area:2/1/3/2] lg:[grid-area:1/2/2/3]">
              ...
              >
                ...
                <div className="ml-4 flex flex-col gap-2">
                  <h5 className="text-xl font-bold">Fixed Price Model</h5>
              ...
              >
                ...
                <div className="ml-4 flex flex-col gap-2">
                  <h5 className="text-xl font-bold">Hire Dedicated Model</h5>
                  <p className="text-sm text-gray-500">
              ...
              >
                ...
                <div className="ml-4 flex flex-col gap-2">
                  <h5 className="text-xl font-bold">Onsite Model</h5>
                  <p className="text-sm text-gray-500">
...
<path d="M14 21L10 21" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
<path d="M12 6C9.23858 6 7 8.23858 7 11C7 12.6383 7.78795 14.0926 9.00556 15.0045C9.4969 15.3725 9.74258 15.5565 9.83968 15.7067C9.88955 15.7838 9.90623 15.8171 9.93805 15.9032C10 16.071 10 16.2931 10 16.7374C10 17.4516 10 17.8088 10.1741 18.0638C10.2444 18.1667 10.3333 18.2556 10.4362 18.3259C10.6912 18.5 11.0484 18.5 11.7626 18.5H12.2374C12.9516 18.5 13.3088 18.5 13.5638 18.3259C13.6667 18.2556 13.7556 18.1667 13.8259 18.0638C14 17.8088 14 17.4516 14 16.7374C14 16.2931 14 16.071 14.062 15.9032C14.0938 15.8171 14.1104 15.7838 14.1603 15.7067C14.2574 15.5565 14.5031 15.3725 14.9944 15.0045C16.212 14.0926 17 12.6383 17 11C17 8.23858 14.7614 6 12 6Z" stroke="#3232bd" stroke-width="1.7" class="my-path"></path>
<path d="M12 2V3" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
<path d="M21 10L20 10" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
<path d="M3 10L4 10" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
<path d="M19.0001 5L18.293 5.70711" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
<path d="M5 5L5.70711 5.70711" stroke="#3232bd" stroke-width="1.7" stroke-linecap="round" class="my-path"></path>
</svg>
              <p className="text-xl font-semibold">Ideation</p>
              <p className="text-sm text-gray-500">
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.19728 5.37752C9.19728 4.93569 9.55545 4.57752 9.99728 4.57752L20.9973 4.57752C21.4391 4.57752 21.7973 4.93569 21.7973 5.37752C21.7973 5.81935 21.4391 6.17752 20.9973 6.17752L9.99728 6.17752C9.55545 6.17752 9.19728 5.81935 9.19728 5.37752Z" fill="#3232bd" class="my-path"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.19728 12.3775C9.19728 11.9357 9.55545 11.5775 9.99728 11.5775L20.9973 11.5775C21.4391 11.5775 21.7973 11.9357 21.7973 12.3775C21.7973 12.8194 21.4391 13.1775 20.9973 13.1775L9.99728 13.1775C9.55545 13.1775 9.19728 12.8194 9.19728 12.3775Z" fill="#3232bd" class="my-path"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.19728 19.3775C9.19728 18.9357 9.55545 18.5775 9.99728 18.5775L20.9973 18.5775C21.4391 18.5775 21.7973 18.9357 21.7973 19.3775C21.7973 19.8194 21.4391 20.1775 20.9973 20.1775H9.99728C9.55545 20.1775 9.19728 19.8193 9.19728 19.3775Z" fill="#3232bd" class="my-path"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.47934 17.1422C7.79176 17.4546 7.79176 17.9612 7.47934 18.2736L4.89534 20.8576C4.74531 21.0076 4.54183 21.0919 4.32966 21.0919C4.11748 21.0919 3.914 21.0076 3.76397 20.8576L2.43353 19.5271C2.12111 19.2147 2.12111 18.7082 2.43353 18.3958C2.74595 18.0833 3.25248 18.0833 3.5649 18.3958L4.32966 19.1605L6.34797 17.1422C6.66038 16.8298 7.16692 16.8298 7.47934 17.1422Z" fill="#3232bd" class="my-path"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.47934 10.1422C7.79176 10.4546 7.79176 10.9612 7.47934 11.2736L4.89534 13.8576C4.74531 14.0076 4.54183 14.0919 4.32966 14.0919C4.11748 14.0919 3.914 14.0076 3.76397 13.8576L2.43353 12.5271C2.12111 12.2147 2.12111 11.7082 2.43353 11.3958C2.74595 11.0833 3.25248 11.0833 3.5649 11.3958L4.32966 12.1605L6.34797 10.1422C6.66038 9.82978 7.16692 9.82978 7.47934 10.1422Z" fill="#3232bd" class="my-path"></path>
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.47934 3.14227C7.79176 3.45469 7.79176 3.96122 7.47934 4.27364L4.89534 6.85764C4.74531 7.00767 4.54183 7.09195 4.32966 7.09195C4.11748 7.09195 3.914 7.00767 3.76397 6.85764L2.43353 5.5272C2.12111 5.21478 2.12111 4.70825 2.43353 4.39583C2.74595 4.08341 3.25248 4.08341 3.5649 4.39583L4.32966 5.16058L6.34797 3.14227C6.66038 2.82985 7.16692 2.82985 7.47934 3.14227Z" fill="#3232bd" class="my-path"></path>
</svg>
            ...
            <div className="grid gap-4 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              {/* <img
						...
						/> */}
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M19.1409 3.77713C18.8302 3.47831 18.542 3.2012 18.2762 3.00643C17.9817 2.79067 17.6237 2.60568 17.1734 2.61146C16.723 2.61724 16.3699 2.81136 16.081 3.03461C15.8203 3.23615 15.5393 3.52056 15.2364 3.82726L14.6562 4.41448L19.5336 9.29189L20.194 8.6235C20.4968 8.3171 20.778 8.03263 20.9757 7.77002C21.1944 7.47971 21.3864 7.12132 21.3805 6.66704C21.3747 6.21277 21.1736 5.85942 20.9476 5.57482C20.7431 5.31737 20.4548 5.04023 20.1442 4.7417L19.1409 3.77713Z" fill="#3232bd" class="my-path"></path>
<path d="M7.44939 11.7085L13.5316 5.55265L18.409 10.4301L12.4068 16.5049L12.3621 16.5503C12.1824 16.7331 11.9829 16.9361 11.7257 17.0696C11.4692 17.2026 11.1882 17.2496 10.9339 17.2922L10.8706 17.3028L9.71961 17.4982C9.14267 17.5962 8.6263 17.6839 8.21 17.6941C7.76297 17.7051 7.25498 17.6344 6.84622 17.2414C6.4348 16.8459 6.34799 16.3398 6.34766 15.8925C6.34735 15.4793 6.42329 14.9658 6.50756 14.3959L6.67626 13.2542L6.68545 13.1912C6.72192 12.9398 6.76293 12.6571 6.89301 12.3973C7.02269 12.1382 7.22417 11.9353 7.40422 11.754L7.44939 11.7085Z" fill="#3232bd" class="my-path"></path>
<path d="M2.99922 20.2002C2.55739 20.2002 2.19922 20.5584 2.19922 21.0002C2.19922 21.442 2.55739 21.8002 2.99922 21.8002H20.9992C21.441 21.8002 21.7992 21.442 21.7992 21.0002C21.7992 20.5584 21.441 20.2002 20.9992 20.2002H2.99922Z" fill="#3232bd" class="my-path"></path>
</svg>
            ...
            <div className="grid gap-4 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              {/* <img
						...
						/> */}
              <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.20117 3.99971C9.20117 3.00559 10.0071 2.19971 11.0012 2.19971H13.0012C13.9953 2.19971 14.8012 3.00559 14.8012 3.99971V5.99971C14.8012 6.99382 13.9953 7.79971 13.0012 7.79971H11.0012C10.0071 7.79971 9.20117 6.99382 9.20117 5.99971V3.99971Z" fill="#3232bd" class="my-path"></path>
<path d="M6.00117 12.1997C4.45477 12.1997 3.20117 13.4533 3.20117 14.9997V15.9997C3.20117 16.4415 3.55934 16.7997 4.00117 16.7997C4.443 16.7997 4.80117 16.4415 4.80117 15.9997V14.9997C4.80117 14.337 5.33843 13.7997 6.00117 13.7997H11.2012V15.9997C11.2012 16.4415 11.5593 16.7997 12.0012 16.7997C12.443 16.7997 12.8012 16.4415 12.8012 15.9997V13.7997H18.0012C18.6639 13.7997 19.2012 14.337 19.2012 14.9997V15.9997C19.2012 16.4415 19.5593 16.7997 20.0012 16.7997C20.443 16.7997 20.8012 16.4415 20.8012 15.9997V14.9997C20.8012 13.4533 19.5476 12.1997 18.0012 12.1997H12.8012V9.99971C12.8012 9.55788 12.443 9.19971 12.0012 9.19971C11.5593 9.19971 11.2012 9.55788 11.2012 9.99971V12.1997H6.00117Z" fill="#3232bd" class="my-path"></path>
<path d="M2.20117 19.9997C2.20117 19.0056 3.00706 18.1997 4.00117 18.1997C4.99528 18.1997 5.80117 19.0056 5.80117 19.9997C5.80117 20.9938 4.99528 21.7997 4.00117 21.7997C3.00706 21.7997 2.20117 20.9938 2.20117 19.9997Z" fill="#3232bd" class="my-path"></path>
<path d="M12.0012 18.1997C11.0071 18.1997 10.2012 19.0056 10.2012 19.9997C10.2012 20.9938 11.0071 21.7997 12.0012 21.7997C12.9953 21.7997 13.8012 20.9938 13.8012 19.9997C13.8012 19.0056 12.9953 18.1997 12.0012 18.1997Z" fill="#3232bd" class="my-path"></path>
<path d="M18.2012 19.9997C18.2012 19.0056 19.0071 18.1997 20.0012 18.1997C20.9953 18.1997 21.8012 19.0056 21.8012 19.9997C21.8012 20.9938 20.9953 21.7997 20.0012 21.7997C19.0071 21.7997 18.2012 20.9938 18.2012 19.9997Z" fill="#3232bd" class="my-path"></path>
</svg>
              <p className="text-xl font-semibold">Implement</p>
              <p className="text-sm text-gray-500">
                Lorem ipsum dolor sit amet consectetur adipiscing elit ut
                aliquam, purus sit.
              </p>
            ...
            <div className="grid gap-4 rounded-md border border-solid border-gray-300 p-8 md:p-10">
              {/* <img
						...
						/> */}
             <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M7.79922 21.0004L7.79922 17.7161C9.51375 17.3487 10.7992 15.8247 10.7992 14.0004C10.7992 11.9017 9.0979 10.2004 6.99922 10.2004C4.90054 10.2004 3.19922 11.9017 3.19922 14.0004C3.19922 15.8247 4.48468 17.3487 6.19922 17.7161V21.0004C6.19922 21.4422 6.55739 21.8004 6.99922 21.8004C7.44105 21.8004 7.79922 21.4422 7.79922 21.0004Z" fill="#3232bd" class="my-path"></path>
<path d="M17.8008 6.28511C19.5145 6.65308 20.7992 8.17672 20.7992 10.0004C20.7992 12.0991 19.0979 13.8004 16.9992 13.8004C14.9005 13.8004 13.1992 12.0991 13.1992 10.0004C13.1992 8.17561 14.4855 6.65123 16.2008 6.28444L16.2008 3.00032C16.2008 2.55849 16.559 2.20032 17.0008 2.20032C17.4426 2.20032 17.8008 2.55849 17.8008 3.00032L17.8008 6.28511Z" fill="#3232bd" class="my-path"></path>
<path d="M6.99922 8.80042C6.55739 8.80042 6.19922 8.44224 6.19922 8.00042L6.19922 3.00042C6.19922 2.55859 6.55739 2.20042 6.99922 2.20042C7.44105 2.20042 7.79922 2.55859 7.79922 3.00041L7.79922 8.00042C7.79922 8.44224 7.44105 8.80042 6.99922 8.80042Z" fill="#3232bd" class="my-path"></path>
<path d="M17.8008 16.0003C17.8008 15.5585 17.4426 15.2003 17.0008 15.2003C16.559 15.2003 16.2008 15.5585 16.2008 16.0003V21.0003C16.2008 21.4421 16.559 21.8003 17.0008 21.8003C17.4426 21.8003 17.8008 21.4421 17.8008 21.0003V16.0003Z" fill="#3232bd" class="my-path"></path>
</svg>
